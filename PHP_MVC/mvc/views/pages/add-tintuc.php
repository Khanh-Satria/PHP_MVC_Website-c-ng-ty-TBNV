            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="title text-white">Thêm din tức</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="st-body" class="container">
        <div class="row">
            <div class="container">
                ...
                <form action="./TinTuc/Add/" method="post" class="was-validated" role="form" enctype="multipart/form-data" name="kk">
                    <div class="form-group">
                        <label>Tên tin tức:</label>
                        <input name="txtTenTinTuc" type="text" class="form-control" placeholder="Tên dự án" required>
