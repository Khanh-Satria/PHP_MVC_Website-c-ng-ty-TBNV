			...
			<div class="section-content">
				<div class="row">
					<div class="col-md-12 text-center">
						<h2 class="title text-white"><?php echo $cttt->ten_tin_tuc; ?></h2>
						<nav role="navigation" class="breadcrumb-trail breadcrumbs">
							<div class="breadcrumbs">
								<span class="trail-item trail-begin"><a href="./Home" title="Trang chủ"><span>Trang chủ</span></a>
									<meta itemprop="position" content="1">
								</span> <span><i class="fa fa-angle-right"></i></span> <span class="trail-item "><a href="./TinTuc/" title="Dự án tiêu biểu"><span>Tin Tức</span></a>
		...
		<div class="row">
			<div id="st-content" class="col-sm-8">
				<div class="articlecontent">
					<div class="detail">
						<h1 class="modheading"><?php echo $cttt->ten_tin_tuc; ?></h1>
						<div class="fulltext">
							<?php $mang = explode("*",  filter_var(trim($cttt->mo_ta, "*")));
							...
							<p> <img src="uploads/<?php echo $cttt->hinh_anh; ?>" /> </p>
